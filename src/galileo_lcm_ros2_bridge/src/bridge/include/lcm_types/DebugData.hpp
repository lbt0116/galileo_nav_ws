...
#ifndef __lcm_types_DebugData_hpp__
#define __lcm_types_DebugData_hpp__
...
int DebugData::getEncodedSize() const
{
...
const char* DebugData::getTypeName()
{
    return "DebugData";
}
...
{
    uint64_t hash = 0xb8227c5c22c9f47bLL;
