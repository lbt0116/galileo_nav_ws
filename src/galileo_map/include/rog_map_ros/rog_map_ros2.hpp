...
// ROS2-only project: remove ROS1/dual-define guards
...
namespace rog_map {
    ...
    class ROGMapROS : public ROGMap {
        ...
        void odomCallback(const nav_msgs::msg::Odometry::SharedPtr odom_msg) {
            ...
            transformStamped.header.frame_id = cfg_.tf_parent_frame_id;
            transformStamped.child_frame_id = cfg_.tf_child_frame_id;
    ...
    public:
        using Ptr = shared_ptr<ROGMapROS>;
